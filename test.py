...
def get_weather_data(city: str) -> dict[str, Any] | None:
    """
    从高德天气查询API获取天气数据
    :param city: 城市中文名称
    ...
    with httpx.Client() as client:
        try:
            response = client.get(WEATHER_API_URL, params=params, headers=headers, timeout=30.0)
